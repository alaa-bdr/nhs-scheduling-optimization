"""Random Forest regression for operation duration prediction.
...
def run():
    ...
    print(f"Combinations: {2 * 3 * 2} x 5 folds = {2 * 3 * 2 * 5} fits")
    ...
    print(f"Random Forest improvement: {hospital_mae - mae:.1f} mins better")
