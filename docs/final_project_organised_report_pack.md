...
For `meaningful_overrun_flag`, the final XGBoost classifier achieved accuracy 0.811, balanced accuracy 0.802, ROC AUC 0.887, PR AUC 0.797, precision 0.671, recall 0.778 and F1 0.720 ([cross target summary](#projectsummary2026)). This is the defensible 80%+ result: the classification model exceeded 80% accuracy and balanced accuracy.
...
<tr><td>Meaningful overrun</td><td>XGBoost</td><td>Accuracy 81.07 percent and balanced accuracy 80.17 percent</td><td>Strongest classification result</td></tr>
...
<tr><td>Duration error</td><td>XGBoost</td><td>R squared about 0.424 and MAE about 31.11 minutes</td><td>Harder correction target</td></tr>
</table>
